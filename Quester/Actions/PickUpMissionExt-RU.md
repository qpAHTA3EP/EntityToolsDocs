...
4. Если задан [*RequiredRewardItem*](#ref-RequiredRewardItem), то проверяется его наличие в составе наград за выполнение миссии.  
   В случае отсутствия необходимого предмета, выполняется безусловный переход к команде с идентификатором [*TargetActionOnRequiredRewardMissing*](#ref-TargetActionOnRequiredRewardMissing).
