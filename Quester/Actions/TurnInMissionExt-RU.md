...
4. Если задан [*RequiredRewardItem*](#ref-RequiredRewardItem), то проверяется его наличие в составе наград за выполненную миссию.  
...
||**Дополнительные опции <br/>(категория "Optional")**** 
...
Для этого в игровом окне нужно подвести игрового персонажа вплотную к соответствующему *NPC*, направить на него игровую камеру и нажать F12.<br/> 
   <p align="center"><img src="img/TurnInMissionExt-GatherInfo-GiverIdentification.png"></p>
...
Если закрыть окно, то опция [*RequiredRewardItem*](#ref-RequiredRewardItem) останется незаполненной, а проверка - отключится.<br/>
   <p align="center"><img src="img/TurnInMissionExt-GatherInfo-RequiredRewardItem.png"></p>
